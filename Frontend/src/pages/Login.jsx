...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post(
        'https://campus-connect-1tr3.onrender.com//auth/login',
        { username, password },
        { withCredentials: true }
      );
      if (response.status === 200) {
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        'https://campus-connect-1tr3.onrender.com//auth/verify-login',
        { username, otp },
        { withCredentials: true }
      );
      if (response.status === 200) {
  ...
  const handleResendOtp = async () => {
    ...
    try {
      const response = await axios.post(
        'https://campus-connect-1tr3.onrender.com//auth/resend-otp',
        { username },
        { withCredentials: true }
      );
      if (response.status === 200) {
