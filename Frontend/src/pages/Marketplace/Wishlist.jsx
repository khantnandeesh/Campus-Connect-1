...
const Wishlist = () => {
  ...
  useEffect(() => {
    const fetchWishlist = async () => {
      try {
        const response = await axios.get("https://campus-connect-1-7rgs.onrender.com/api/marketplace/wishlist", { withCredentials: true });
  ...
  const removeFromWishlist = async (productId) => {
    try {
      await axios.delete(`https://campus-connect-1-7rgs.onrender.com/api/marketplace/wishlist/${productId}`, { withCredentials: true });
