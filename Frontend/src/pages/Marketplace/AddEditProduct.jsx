...
const AddEditProduct = () => {
  ...
  useEffect(() => {
    if (id) {
      const fetchProduct = async () => {
        try {
          const response = await axios.get(`https://campus-connect-1-7rgs.onrender.com/api/marketplace/products/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (id) {
        await axios.put(`https://campus-connect-1-7rgs.onrender.com/api/marketplace/products/${id}`, formData, {
          headers: { "Content-Type": "multipart/form-data" },
          withCredentials: true,
        });
        toast.success("Product updated successfully!");
      } else {
        await axios.post("https://campus-connect-1-7rgs.onrender.com/api/marketplace/products", formData, {
          headers: { "Content-Type": "multipart/form-data" },
          withCredentials: true,
        });
